...
public class ArmExtensionSubsystem extends SubsystemBase {
    ...
    public void smartDashboardInit() {
        //*P SmartDashboard.putBoolean(getName() + "/Arm Extension Prof Const Enable", false);

        //*P SmartDashboard.putNumber(getName() + "/Arm Extension P", m_armExtensionMotorPidController.getP());
        //*P SmartDashboard.putNumber(getName() + "/Arm Extension I", m_armExtensionMotorPidController.getI());
        //*P SmartDashboard.putNumber(getName() + "/Arm Extension D", m_armExtensionMotorPidController.getD());
        //*P SmartDashboard.putNumber(getName() + "/Arm Extension FF", m_armExtensionMotorPidController.getFF());
        //*P SmartDashboard.putNumber(getName() + "/Arm Extension Izone", m_armExtensionMotorPidController.getIZone());

        //*P SmartDashboard.putNumber(getName() + "/Arm Extension Max Accel", kSmartMaxAccel);
        //*P SmartDashboard.putNumber(getName() + "/Arm Extension Max Vel", kSmartMaxVel);
        //*P SmartDashboard.putNumber(getName() + "/Arm Extension Closed Loop Error", 0);
    }

    public void smartDashboardUpdate() {
        //*P m_armExtensionMotorPidController.setP(SmartDashboard.getNumber(getName() + "/Arm Extension P", kArmExtensionP));
        //*P m_armExtensionMotorPidController.setI(SmartDashboard.getNumber(getName() + "/Arm Extension I", kArmExtensionI));
        //*P m_armExtensionMotorPidController.setD(SmartDashboard.getNumber(getName() + "/Arm Extension D", kArmExtensionD));
        //*P m_armExtensionMotorPidController.setFF(SmartDashboard.getNumber(getName() + "/Arm Extension FF", kArmExtensionFF));
        //*P m_armExtensionMotorPidController.setIZone(SmartDashboard.getNumber(getName() + "/Arm Extension Izone", kArmExtensionIzone));
        ...
        if (SmartDashboard.getBoolean(getName() + "/Arm Extension Prof Const Enable", false))
        {
            ...
            //*P m_armExtensionMotorPidController.setSmartMotionMaxAccel(maxAccelExtension, 0);
            //*P m_armExtensionMotorPidController.setSmartMotionMaxVelocity(maxVelExtension, 0);
